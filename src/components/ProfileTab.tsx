...
function WordListView({
  ...
  return (
    <motion.div
      ...
      className="absolute inset-0 z-10 h-dvh overflow-y-auto bg-black pb-20 pt-4 px-5"
    >
      <button
        onClick={onBack}
        className="flex items-center gap-2 text-sm text-white/60 active:text-white transition-colors"
      >
      ...
      <h2 className={`mt-4 text-lg font-bold ${meta.color}`}>
